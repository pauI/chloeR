...
sliding.window <- function( 
  ...
  if(!is.null(shape)) props <- paste0(props, "shape=", shape, "\n")
  if(!is.null(distance_type))  props <- paste0(props, "distance_type=", distance_type, "\n")
  if(!is.null(distance_function)) props <- paste0(props, "distance_function=", distance_function, "\n")
  if(!is.null(friction_file)) props <- paste0(props, "friction_file=", friction_file, "\n")
